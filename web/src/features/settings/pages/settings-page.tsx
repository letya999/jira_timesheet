...
export default function SettingsPage() {
  ...
  const setCountryMutation = useMutation({
    ...
    onSuccess: (countryCode) => toast.success(`Country updated to ${countryCode}`),
              ...
              <CardContent className="space-y-4">
                <div className="flex max-w-xs flex-col gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(code) => setCountryMutation.mutate(code)}
      ...
      {!canManageSettings && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Org and Jira tabs are available to admins only.
            </CardDescription>
          </CardHeader>
        </Card>
      )}
