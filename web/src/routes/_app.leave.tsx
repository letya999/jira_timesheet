...
import { leaveKeys, useLeaveRequests, useCreateLeaveRequest } from '@/features/leave/hooks'
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {requests.map((request: any) => (
            <LeaveRequestCard
              ...
              userEmail={request.user_email || ''} // Using fallback as user_email might be missing from LeaveResponse
