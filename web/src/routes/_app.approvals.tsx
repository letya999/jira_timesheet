...
import { approvalsKeys, useApprovals, useApproveEntry, useRejectEntry, useBulkApprove } from '@/features/approvals/hooks'
...
function ApprovalsPage() {
  const { data: periods, isLoading } = useApprovals({ status: 'SUBMITTED' })
