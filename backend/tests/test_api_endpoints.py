...
from models import User, JiraUser, OrgUnit, Project, Worklog, WorklogCategory, TimesheetPeriod, Issue, Role, ApprovalRoute, UserOrgRole
...
async def test_sync_endpoint(client: AsyncClient, auth_headers: dict, db: AsyncSession, admin_user: User):
    ...
    with patch("api.endpoints.sync.sync_user_worklogs"):
