...
class CalendarService:
    ...
    def _apply_russian_offsets(self, holiday_list):
        """Special patch for Russia: shift holidays falling on weekends."""
        observed_holidays = {}
    ...
    async def sync_holidays(self, db: AsyncSession, year: int | None = None):
        ...
        if country_code == "RU":
            self._apply_russian_offsets(holiday_list)
