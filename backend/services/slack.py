...
class SlackService:
    ...
    async def send_leave_request_notification(
        self, user_name: str, leave_type: str, start_date: str, end_date: str, reason: str, leave_id: int
    ):
        ...
        blocks = [
            {"type": "section", "text": {"type": "mrkdwn", "text": f"👤 *{user_name}* requested a *{leave_type}*"}},
            {
                "type": "section",
                "fields": [
            ...
            {"type": "section", "text": {"type": "mrkdwn", "text": f"*Reason:* {reason or 'No reason provided'}"}},
            {
                "type": "actions",
                "elements": [
                    {
