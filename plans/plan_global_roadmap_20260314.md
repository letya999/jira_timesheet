# Plan: Write Global Roadmap File

## Goal
Create `ROADMAP.md` in the project root (`C:\Users\User\a_projects\jira_timesheet\ROADMAP.md`) — a comprehensive, developer-facing migration roadmap from Streamlit to React.

## Output File
`C:\Users\User\a_projects\jira_timesheet\ROADMAP.md`

## Content to Write

The file must contain the following content EXACTLY (write it verbatim):
